 ...
 * JSONBigInt parser.
 */
const { parse } = (0, json_bigint_1.default)({ storeAsString: true, strict: true }); // eslint-disable-line new-cap
/**
...
class Parser {
    ...
    rpc(response) {
        ...
        if (typeof response.body === 'string' && response.headers['content-type'] !== 'application/json' && response.statusCode !== 200) {
            throw new rpc_error_1.default(response.statusCode, response.statusMessage, { body: response.body });
        }
