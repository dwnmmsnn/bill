 ...
 */
class Client {
    constructor({ agentOptions, headers = false, host = 'localhost', logger = (0, debugnyan_1.default)('bitcoin-core'), network = 'mainnet', password, port, ssl = false, timeout = 30000, username, version, wallet } = {}) {
        ...
        this.requester = new requester_1.default({ methods: this.methods, version });
        this.parser = new parser_1.default({ headers: this.headers });
    }
    /**
     * Execute `rpc` command.
     */
    ...
    getBlockByHash(hash, { summary = false, extension = 'json' } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.parser.rest(extension, yield this.request.getAsync({ encoding, url }));
        });
    }
    /**
