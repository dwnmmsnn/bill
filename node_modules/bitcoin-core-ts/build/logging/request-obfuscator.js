...
function obfuscateResponseBody(body, method) {
    ...
    return (0, lodash_1.defaults)({ result: fn(body.result) }, body);
}
/**
...
function obfuscateRequestBody(body) {
    ...
    if ((0, lodash_1.isPlainObject)(body.params)) {
        return (0, lodash_1.assign)(body, { params: method.named(body.params) });
    }
    return (0, lodash_1.assign)(body, { params: method.default(body.params) });
}
/**
